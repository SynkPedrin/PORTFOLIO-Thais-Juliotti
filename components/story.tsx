  ...
  return (
    <section id="historia" className="mx-auto max-w-7xl scroll-mt-24 px-6 py-24 lg:px-10 lg:py-36">
      <div className="grid gap-14 lg:grid-cols-12">
        <CinematicReveal stagger={0.1} className="lg:col-span-4">
          ...
          <CinematicRevealItem>
            <h2 className="mt-6 font-serif text-[clamp(2rem,5vw,3.25rem)] font-light leading-[1.05] tracking-tight text-foreground">
              <TextLineReveal>
                <span>Uma câmera, um propósito</span>
                <span>e um chamado</span>
              </TextLineReveal>
            </h2>
          </CinematicRevealItem>
          <CinematicRevealItem variant="fade-up">
          ...
          <ol className="relative border-l border-border">
            {TIMELINE.map((item, i) => (
              <li key={item.title} className="relative pb-12 pl-8 last:pb-0">
                <CinematicReveal variant="fade-up" delay={i * 0.15}>
                  <span
